var app = angular.module('app', ["ngResource", 'ngCookies', 'ngRoute', 'ui.bootstrap', 'ui.select',
 'ngSanitize', 'xeditable', 'toaster', 'ngAnimate', 'textAngular' , 'ngFileUpload', 'NgSwitchery']);
...
app.controller('commentsController', function ($scope, taskCommentsResource, $routeParams, taskResource, 
  notificationResource, taskCommentsResource, $timeout, $location, toaster, fileUpload) {
...
app.controller('todoController', function ($scope, todoResource, $timeout, $routeParams) {
  ...
  getTodoTask = function() {
    if(taskId){
      ...
      todoResource.query({user: 1, task_is_null : "True"}, function(data){
        $scope.todoTasks = data;
      });
    }
  };
...
app.controller('configController', function ($scope, clientResource, organizationResource) {
