var app = angular.module('app', ["ngResource", 'ngCookies', 'ngRoute', 'ui.bootstrap', 'ui.select',
 'ngSanitize', 'xeditable', 'toaster', 'ngAnimate', 'textAngular' , 'ngFileUpload', 'ui.bootstrap.modal']);
...
app.controller('modalController', function ($scope, taskResource, clientResource, moduleResource) {
